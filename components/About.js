                ...
                <div className="relative z-10 pb-8  sm:pb-16 md:pb-20  mx-auto pt-0.5">
                    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 mx-auto">
                        <div className="p-8 sm:text-center md:text-center mx-auto">
                            <div className="uppercase tracking-wide sm:text-center text-xl text-blue-dark font-Poppins-bold">About Me</div>
                        </div>
                        <div className="lg:flex lg:justify-center">
                            <div class="lg:flex-shrink-0">
                                <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://via.placeholder.com/400x400" alt="" />
                            </div>
                            <div className="p-8 sm:text-left lg:text-left bg-text-bright">
                                <div className="uppercase tracking-wide text-xl text-blue-light font-Poppins">Lorem Ipsum</div>
